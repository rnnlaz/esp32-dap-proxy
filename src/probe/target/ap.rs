...
pub const CSW_32_OFF: u32 =
    CSW_SIZE_32 | CSW_ADDRINC_OFF | CSW_DBGSWEN | CSW_DEVICE_EN | CSW_EXTRA_BITS;
pub const CSW_32_SINGLE: u32 =
    CSW_SIZE_32 | CSW_ADDRINC_SINGLE | CSW_DBGSWEN | CSW_DEVICE_EN | CSW_EXTRA_BITS;
